                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Shifokor ismi, emaili yoki sanani (YYYY-OO-KK) kiriting" list="doctors" >&nbsp;&nbsp;
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Shifokor ismi:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            Shifokor pochta manzili:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        <div class="h3-search" style="font-size:18px;">
                                                          
                                                        </div><br>
                                                        <div class="h3-search" style="font-size:18px;">
                                                            Sessiya nomi: '.$title.'<br>
                                                            Sessiya belgilangan Sanasi: '.$scheduledate.'<br>
                                                            Sessiya boshlanish vaqti: '.$scheduletime.'<br>
                                                            To`lov narxi : <b>90 ming so`m</b>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="Navbat olish" name="booknow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
