...
$sqlmain = "SELECT appointment.appoid, schedule.scheduleid, schedule.title, patient.pname, schedule.scheduledate, schedule.scheduletime, appointment.apponum, appointment.appodate 
            ...
            WHERE doctor.docid = $userid AND schedule.scheduledate >= '$today' 
            ORDER BY schedule.scheduledate ASC";
$appointments = $database->query($sqlmain);

// Fetch today's sessions for this doctor
$sqlschedule = "SELECT schedule.scheduleid, schedule.title, schedule.scheduledate, schedule.scheduletime, schedule.nop 
                FROM schedule 
                INNER JOIN doctor ON schedule.docid = doctor.docid 
                WHERE doctor.docid = $userid AND schedule.scheduledate = '$today'";
$sessions = $database->query($sqlschedule);
?>
...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div class="sidebar bg-white h-screen shadow-lg fixed left-0 top-0 w-64 z-10 dark:bg-gray-800">
        <div class="p-5 border-b dark:border-gray-700">
            <h1 class="text-xl font-bold text-blue-600 dark:text-blue-400">eDoc Doctor</h1>
    ...
    <div class="main-content ml-64">
        ...
        <div class="card mb-8">
            <div class="card-body bg-blue-50 dark:bg-blue-900/30">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    Bu sizning shaxsiy boshqaruv panelingiz. Bu yerda kelajakdagi uchrashuvlaringizni ko'rishingiz 
                    hamda bemorlaringiz bilan ishlashingiz mumkin.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Stats Cards -->
            <div>
                <h2 class="text-xl font-semibold text-gray-800 mb-4 dark:text-white">Statistika</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="dashboard-card">
                        ...
                        <div class="mt-2 text-blue-500 text-sm">
                            <i class="fas fa-user-md mr-1"></i>Registered
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        <div class="dashboard-card-title">Bugungi uchrashuvlar</div>
            ...
            <div>
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Bugungi uchrashuvlar</h2>
                    <a href="appointment.php" class="text-blue-600 hover:underline text-sm dark:text-blue-400">
                        <i class="fas fa-list mr-1"></i>Barchasini ko'rish
                    </a>
                </div>
                    ...
                    <div class="card-body">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                        <?php while ($row = $appointments->fetch_assoc()): ?>
                                            <tr class="table-row">
                                                ...
                                                <td class="table-cell"><?php echo substr($row['title'], 0, 20); ?></td>
                                                <td class="table-cell">
                        ...
                        <?php else: ?>
                            <div class="text-center py-8">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Hozircha uchrashuvlaringiz mavjud emas</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="mt-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Bugungi sessiyalar</h2>
                <a href="schedule.php" class="text-blue-600 hover:underline text-sm dark:text-blue-400">
                    <i class="fas fa-calendar-plus mr-1"></i>Yangi sessiya qo'shish
                </a>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <?php if ($sessions->num_rows > 0): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <?php while ($row = $sessions->fetch_assoc()): ?>
                                <div class="dashboard-card">
                                    <h3 class="font-semibold text-lg mb-2 dark:text-white"><?php echo $row['title']; ?></h3>
                                    <p class="text-gray-600 mb-1 dark:text-gray-300">
                                        <i class="far fa-calendar-alt mr-2"></i>
                                        <?php echo $row['scheduledate']; ?>
                                    </p>
                                    <p class="text-gray-600 mb-3 dark:text-gray-300">
                                        <i class="far fa-clock mr-2"></i>
                                        <?php echo substr($row['scheduletime'], 0, 5); ?>
                                    </p>
                                    <p class="text-gray-600 dark:text-gray-300">
                                        <i class="fas fa-user-friends mr-2"></i>
                                        <?php echo $row['nop']; ?> bemor
                                    </p>
                                </div>
                            <?php endwhile; ?>
                        </div>
                    <?php else: ?>
                        <div class="text-center py-8">
                            <i class="fas fa-calendar-plus text-gray-400 text-4xl mb-4 dark:text-gray-500"></i>
                            <p class="text-gray-500 mb-4 dark:text-gray-400">Bugun uchun sessiyalar mavjud emas</p>
                            <a href="schedule.php" class="btn-primary inline-block">
                                <i class="fas fa-plus mr-2"></i>Yangi sessiya qo'shish
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
